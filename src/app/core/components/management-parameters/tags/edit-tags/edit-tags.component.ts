...
export class EditTagsComponent implements OnInit {
    ...
    confirmUpdate(): void {
        if (this.formTag.valid) {
            this.confirmationService.confirm({
                ...
                accept: () => {
                    ...
                    if (this.tagId) {
                        ...
                        console.error("El tagId está indefinido. No se puede actualizar el Grupo.");
                    }
                },
                reject: () => {
            ...
            this.messageService.add({ severity: 'warn', summary: 'Advertencia', detail: 'Por favor, revisa los campos antes de continuar.' });
        }
    }
